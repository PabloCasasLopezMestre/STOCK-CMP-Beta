          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 rounded-xl p-5 border border-slate-700/50">
              ...
              <ol className="text-slate-300 text-sm space-y-2 list-decimal list-inside leading-relaxed">
                ...
                <li>{s('En el Comparador puedes elegir qué acciones aparecen en la banda de precios: "Acciones seleccionadas" muestra las del comparador, "Personalizada" te permite agregar cualquier símbolo manualmente.', 'In the Comparator you can choose which stocks appear in the price ticker: "Selected stocks" shows the comparator ones, "Custom" lets you add any symbol manually.')}</li>
          ...
          <div className="space-y-4">
            {[
              ...
              { title: s('Ajustes', 'Settings'), items: [
                ...
                s('Banda de precios personalizable: elige entre mostrar las acciones del comparador o agregar símbolos manualmente', 'Customizable price ticker: choose between showing comparator stocks or adding symbols manually'),
